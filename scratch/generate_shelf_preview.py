...
shelf_svg = '''
<!-- Enhanced Shelf matching User Image 1 -->
...
end_pos = svg_content.find(end_marker)

new_svg = svg_content[:start_pos] + shelf_svg.strip() + svg_content[end_pos:]

with open('scratch/preview_online_learning.svg', 'w', encoding='utf-8') as f:
    f.write(new_svg)

print("Saved scratch/preview_online_learning.svg successfully!")
